...
// Tabs removed - using custom buttons for better mobile UX
...
export default function UtilizationPilot() {
  ...
  const { creditCards, overallUtilization, totalLimit, totalBalance, recommendations, summary } = displayData || {};
